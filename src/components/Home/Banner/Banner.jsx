...
const Banner = ({ handelSearch, setSearchText, searchText }) => {
  return (
    <div className=" bg-gradient-to-r from-[#061f31] to-[#03043b] relative h-[800px]  w-full">
      <div className=" relative h-[800px] ml-26  mx-auto">
        {/* <img
          src="https://i.ibb.co/550RR55/html-css-collage-concept-with-person.jpg"
          className="h-[700px] w-full opacity-50  "
          alt=""
        /> */}
        <Lottie  className="h-[700px] w-full opacity-50" animationData={animationData} loop={true}></Lottie>
        ...
        <div className="z-40 absolute hidden pt-28 lg:block opacity-80  top-1 text-slate-200 py-10 px-5  ml-32">
